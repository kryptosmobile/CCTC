    ...
    .controller('LoginCtrl', ['$scope', '$rootScope', '$http', '$location',
        function ($scope, $rootScope, $http, $location) {
            ...
            $scope.forgotpassword = function() {
                ...
                var iabRef = window.open("https://ssotest.cctech.edu/cas/login", "_blank", "location=no,hidden=yes,EnableViewPortScale=yes");
                ...
                var loadStop = function(data) {
                    window.open(url, "_blank", "location=no,hidden=no,enableViewportScale=yes");
                    hideBlockUi();
                };
